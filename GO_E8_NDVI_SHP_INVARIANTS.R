...
GO_E8_NDVI_INVARIANTS_SHP=function(ndvi_invs){
  ...
  writeOGR(invs, dsn="GO/Invariants/Spatial_points",layer="ndvi_invariants", driver = "ESRI Shapefile",overwrite=T)
  ...
  ### exporto los puntos invariantes como shapefile
  writeOGR(inv_points, ".", "inv_points", driver="ESRI Shapefile")
